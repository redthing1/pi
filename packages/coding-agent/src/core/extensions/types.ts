...
export interface ExtensionContext {
	...
	/** Get a snapshot of the current base system-prompt construction options. */
...
export interface SessionCompactionCheckEvent {
	...
	readonly context: Readonly<TranscriptContext>;
...
export interface SessionBeforeCompactEvent {
	...
	readonly sourceContext: Readonly<TranscriptContext>;
